...
public class MathTest {
    ...
    public void test1TransMatrix3x3() {
        ...
        Matrix3x3 expected = new Matrix3x3(content);
        Assertions.assertEquals(expected, matrix3x3Result.transposition(matrix3x3First));
    }
    ...
    public void test2TransMatrix3x3() {
        ...
        Matrix3x3 expected = new Matrix3x3(content);
        Assertions.assertEquals(expected, matrix3x3Result.transposition(matrix3x3Second));
    }
    ...
    public void test1TransMatrix4x4() {
        ...
        Matrix4x4 expected = new Matrix4x4(content);
        Assertions.assertEquals(expected, matrix4x4Result.transposition(matrix4x4First));
    }
 @Test
    public void test2TransMatrix4x4() {
        float[][] content = {{2,3,0,3}, {-1,0,-4,-4}, {0,-4,2,0}, {-4,-4,-9,1}};
        Matrix4x4 expected = new Matrix4x4(content);
        Assertions.assertEquals(expected, matrix4x4Result.transposition(matrix4x4Second));
    }
 @Test
